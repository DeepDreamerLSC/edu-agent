# Session 06/24 — `small_lecturer_math_gold_b2_rope_unit_app_misconception_repair`
...
**t1** student: 2.5 米是 25 厘米,25−80 不够减。
    tutor: 你刚才说2.5米是25厘米，能说说你是怎么想到要把米换算成厘米的吗？
    state: dialogue

**t2** student: 单位换算错,1 米=100 厘米,2.5 米=250 厘米,250−80=170 厘米。
    tutor: 你刚才说2.5米等于250厘米，这个换算很对，因为1米是100厘米，2.5米就是250厘米，再减去80厘米，结果是170厘米，没错！
...
Session 标注表 —— Session 编号:06  Reviewer(R1/R2):____  日期:____
