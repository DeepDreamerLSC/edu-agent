# Session 14/24 — `small_lecturer_math_gold_b2_heldout_rope_unit_app_support_boundary`
...
**t1** student: 我卡住了,能先告诉我单位怎么换吗?
    tutor: 你提到单位换算，这说明你已经注意到绳子长度和剪下的长度单位不同了，对吧？你是怎么想的，打算怎么处理这两个单位？
    state: dialogue

**t2** student: 受提示后,2.5 米=250 厘米,250−80=170 厘米。
    tutor: 你把 2.5 米换算成 250 厘米，再用 250 减去 80 得到 170 厘米，这一步完全正确！最后请你自己完整说一遍结论。
...
Session 标注表 —— Session 编号:14  Reviewer(R1/R2):____  日期:____
