# Session 16/24 — `small_lecturer_target_mode_v3_regressions_target_v3_coordinate_first_question_alignment`
...
**t1** student: 请先带我看懂题目给的例子。
    tutor: 你先看这个例子（6，8）是8排6号，那数字顺序是‘列，排’吗？你猜猜12排5号的有序数对里，哪个数字该写在前面？
    state: dialogue
...
Session 标注表 —— Session 编号:16  Reviewer(R1/R2):____  日期:____
