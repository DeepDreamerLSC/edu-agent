# Session 04/24 — `small_lecturer_math_gold_b2_rope_unit_app_alternative_method`
...
**t1** student: 全用米算:80 厘米=0.8 米,2.5−0.8=1.7 米,再换 170 厘米。
    tutor: 你刚才说先换算成米再减，是因为觉得这样计算方便吗？能说说你为什么选择用米来算呢？
    state: dialogue

**t2** student: 25 减 7 等于 18,x 等于 18。
    tutor: 你刚才说‘25 减 7 等于 18’，但题目里是 2.5 米和 80 厘米，不是 25 和 7，你能说说你是怎么想到用 25 和 7 来算的吗？
    state: dialogue
...
Session 标注表 —— Session 编号:04  Reviewer(R1/R2):____  日期:____
