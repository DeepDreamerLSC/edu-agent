# Session 21/24 — `small_lecturer_math_gold_b2_unit_rate_complete_reasoning`
...
**t1** student: 先求单价 48÷4=12 元,再乘 7,12×7=84 元。
    tutor: 你先算出每本书多少钱，再乘以7，这个思路很清晰，你是怎么想到先算单价的呢？
    state: dialogue

**t2** student: 25 减 7 等于 18,x 等于 18。
    tutor: 你刚才说‘25减7等于18，x等于18’，但本题是关于书的价格，不是解方程，我们得先从‘4本书48元’开始想，你打算怎么用这个信息？
    state: dialogue
...
Session 标注表 —— Session 编号:21  Reviewer(R1/R2):____  日期:____
