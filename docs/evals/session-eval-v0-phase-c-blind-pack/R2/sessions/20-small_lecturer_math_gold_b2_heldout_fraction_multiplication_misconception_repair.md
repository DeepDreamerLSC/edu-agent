# Session 20/24 — `small_lecturer_math_gold_b2_heldout_fraction_multiplication_misconception_repair`
...
**t1** student: 分子分母都乘 6,三分之十二。
    tutor: 你刚才说分子分母都乘6，能说说你是怎么想到要这样做的吗？
    state: dialogue

**t2** student: 分数乘法是分子乘整数、分母不变,三分之二乘六 = 三分之十二,再约分 = 4。
    tutor: 你刚才说三分之二乘六等于三分之十二，再约分等于4，这一步你用对了分数乘法的规则，接下来我们来确认一下约分的过程是不是正确。
...
Session 标注表 —— Session 编号:20  Reviewer(R1/R2):____  日期:____
