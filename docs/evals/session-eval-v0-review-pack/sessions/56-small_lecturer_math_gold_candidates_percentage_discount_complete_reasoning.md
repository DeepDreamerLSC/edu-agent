# Session 56/64 — `small_lecturer_math_gold_candidates_percentage_discount_complete_reasoning`
...
**t1** student: 八折表示按原价的80%付款。
    tutor: 你刚才说八折是按原价的80%付款，那接下来你打算怎么用这个信息算出打折后的价格呢？
    state: dialogue

**t2** student: 200乘0.8等于160元。
    tutor: 你用200乘0.8算出160元，这一步完全正确，说明你理解了八折就是原价的80%。那现在我们来确认一下，打折后的价格就是160元对吧？
