# Session 14/64 — `small_lecturer_math_gold_candidates_chicken_rabbit_support_boundary`
...
**t1** student: 我只想到先算一下，但还说不完整。
    tutor: 你说到‘先算一下’，能说说你是怎么想到先算的吗？比如是看到什么数字或关系让你这样想的？
    state: dialogue

**t2** student: 假设全是鸡会有16只脚，比实际少10只。
    tutor: 你算出假设全是鸡时脚数比实际少10只，这一步很准！那这10只脚差是怎么来的呢？每只兔子比鸡多2只脚，你猜猜这10只脚差能对应几只兔子？
    state: dialogue
