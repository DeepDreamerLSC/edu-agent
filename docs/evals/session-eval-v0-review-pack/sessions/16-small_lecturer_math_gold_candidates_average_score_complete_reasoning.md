# Session 16/64 — `small_lecturer_math_gold_candidates_average_score_complete_reasoning`
...
**t1** student: 先把三次成绩相加，得到270。
    tutor: 你先算出三次成绩加起来是270，这一步很关键，你是怎么想到要加起来的？
    state: dialogue

**t2** student: 一共有3次，所以270除以3等于90分。
    tutor: 你用270除以3得到90，这说明你理解了平均分是总分平均分摊到每次的成绩，这一步很到位！
