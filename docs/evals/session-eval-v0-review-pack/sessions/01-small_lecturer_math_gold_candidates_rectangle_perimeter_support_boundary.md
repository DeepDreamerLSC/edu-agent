# Session 01/64 — `small_lecturer_math_gold_candidates_rectangle_perimeter_support_boundary`
...
**t1** student: 我还不知道从哪里开始，能先给我一个小提示吗？
    tutor: 你刚说还不知道从哪里开始，那我们先想想，长方形的周长是什么意思？比如你围一圈，需要走多长？
    state: dialogue

**t2** student: 周长是四条边的总长度，要用8加5再乘2。
    tutor: 你刚才说周长是四条边加起来，这个想法很棒！那为什么要把8加5再乘2呢？是因为长方形有两条长边和两条宽边，对吧？
    state: dialogue
