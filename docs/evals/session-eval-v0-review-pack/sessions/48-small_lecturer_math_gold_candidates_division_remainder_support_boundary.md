# Session 48/64 — `small_lecturer_math_gold_candidates_division_remainder_support_boundary`
...
**t1** student: 我刚才走神了，还没有回答这个问题。
    tutor: 你刚才说还没想好，没关系，我们一起来理清思路——你是怎么想到要怎么分这些书的？比如，你先看第一个条件：每6本装一盒，那你会怎么处理剩下的书？
    state: dialogue

**t2** student: 47除以6等于7余5。
    tutor: 你算出47÷6=7余5，这一步很准！那剩下的5本书，是不是还得再加一个盒子才能装完呢？
    state: dialogue
