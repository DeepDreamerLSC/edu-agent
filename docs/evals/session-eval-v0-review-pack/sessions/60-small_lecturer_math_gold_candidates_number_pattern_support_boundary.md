# Session 60/64 — `small_lecturer_math_gold_candidates_number_pattern_support_boundary`

## 运行注记
- 时长 14.1s;final_state: **needs_review**
...
**t1** student: 我只想到先算一下，但还说不完整。
    tutor: 你提到‘先算一下’，能说说你是怎么观察这组数的？比如相邻两个数之间有什么变化？
    state: dialogue

**t2** student: 相邻两个数都相差3。
    tutor: 你发现相邻数差3，这很棒！那如果继续这个规律，11后面加3会是多少呢？
    state: dialogue
