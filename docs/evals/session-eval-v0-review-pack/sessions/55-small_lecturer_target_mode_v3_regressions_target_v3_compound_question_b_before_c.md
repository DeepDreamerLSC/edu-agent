# Session 55/64 — `small_lecturer_target_mode_v3_regressions_target_v3_compound_question_b_before_c`
...
**t1** student: 题目不是应该先看B点吗？
    tutor: 你刚才说‘题目不是应该先看B点吗？’，那你是怎么想到要从B点开始算的？比如，你打算怎么确定B点相对于A点的方向和距离？
    state: dialogue
