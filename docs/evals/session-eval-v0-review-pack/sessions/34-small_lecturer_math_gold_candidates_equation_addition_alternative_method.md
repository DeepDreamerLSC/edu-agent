# Session 34/64 — `small_lecturer_math_gold_candidates_equation_addition_alternative_method`

## 运行注记
- 时长 8.9s;final_state: **needs_review**
...
**t1** student: 也可以想哪个数加7等于25，用逆运算得到18。
    tutor: 你想到用逆运算求x，这很聪明！那你是怎么知道‘减7’这一步能保持等式两边相等的？
    state: dialogue

**t2** student: 把18代回原式，18加7等于25，所以结果正确。
    tutor: 你用代入法验证18是正确的，这很棒！但解方程时，为什么两边同时减7，等式还能成立呢？
    state: dialogue
