# Session 49/64 — `small_lecturer_math_gold_candidates_number_pattern_alternative_method`

## 运行注记
- 时长 17.0s;final_state: **needs_review**
...
**t1** student: 也可以写成2加3乘序号减1，看出第五项是14。
    tutor: 你刚才说‘2加3乘序号减1’，是先观察数列里相邻两个数的差，再想到用序号来表示位置的？
    state: dialogue

**t2** student: 11再加3得到14。
    tutor: 你刚才说‘11加3得14’，这说明你发现数列每次加3，这个规律能用来算出下一项，对吗？
