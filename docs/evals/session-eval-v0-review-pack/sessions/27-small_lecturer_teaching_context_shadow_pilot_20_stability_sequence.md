# Session 27/64 — `small_lecturer_teaching_context_shadow_pilot_20_stability_sequence`
...
**t1** student: 我只看出这些数越来越大。
    tutor: 你刚才说数在变大，那从2到5，中间隔了几个数？你是怎么想到它们之间有固定差值的？
    state: dialogue

**t2** student: 相邻两个数的差好像都是3。
    tutor: 你发现相邻数差都是3，那从11往后加3，下一项就是□，对吗？
    state: dialogue

**t3** student: 11再加3得到14。
    tutor: 你刚才说11加3是14，这个计算没错，而且你发现的‘相邻差都是3’是解题关键，下一项就是14啦！
    state: ready_to_confirm

**t4** student: 所以规律是每次增加3，下一项是14，再下一项会是17。
