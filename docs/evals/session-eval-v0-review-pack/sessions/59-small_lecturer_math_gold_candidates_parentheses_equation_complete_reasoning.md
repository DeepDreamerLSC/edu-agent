# Session 59/64 — `small_lecturer_math_gold_candidates_parentheses_equation_complete_reasoning`
...
**t1** student: 等式两边都除以2，得到x加3等于9。
    tutor: 你刚才说等式两边都除以2，能说说你是怎么想到这一步的？比如，你看到等式右边是18，是不是觉得除以2能简化它？
    state: dialogue

**t2** student: 再把两边都减去3，得到x等于6。
    tutor: 你刚才说两边减3得到x等于6，这一步是把等式两边同时减去3，和之前除以2一样，都是保持等式平衡的，对吗？
