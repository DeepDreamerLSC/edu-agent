# Session 06/64 — `small_lecturer_math_gold_candidates_number_pattern_complete_reasoning`
...
**t1** student: 相邻两个数都相差3。
    tutor: 你发现相邻两个数都相差3，那你是怎么从8推到11的？
    state: dialogue

**t2** student: 11再加3得到14。
    tutor: 你刚才说11加3得到14，这一步很对！那我们再确认一下，这个数列的规律是每个数比前一个数多3，对吗？
