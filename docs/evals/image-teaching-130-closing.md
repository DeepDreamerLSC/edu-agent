...
| 3 | 二级误区种子 | **存在与预期不符的实情,需用户裁定**(证据见下) | ⚠️ 待裁定(owner:用户) |
...
- 三态清点(6 条):悬线 1/2/5 ✅ 闭环;悬线 6 ➖ 无后续(处置已记录);**仍悬置 2 条**——悬线 3(二级种子,裁定 i/ii/iii,owner=用户)、悬线 4(answer-leak 口径分叉,owner=PM,已按选项 1 先行并记录为已知口径差异)。
- **结论**:悬线 3 经裁定(采 (i) 或 (ii) 均不阻塞 M2)后,**建议闭 #130**;闭键在用户。悬线 4 为跨线问题(11 场景同受影响),按 Dev C 选项 1 口径推迟 M3 重议,**不作为 #130 闭键**。
