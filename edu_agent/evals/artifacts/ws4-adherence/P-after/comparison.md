...
逐维均分(0-2):首问质量 1.27 | 追问引导 2.00 | 年级适配 2.00 | 节奏 1.82 | 总结与掌握 1.45 | 终止行为 1.45
...
逐维均分:见 judge-scores.json;对两轮均值差:+4.41

## json_first_pass(01 §6 结构化输出合规率)

M2 门 98%: ✅ 当前 **100.0%** (405/405 产出了结果)

| role | responded | ok | rate | breakdown |
|---|---:|---:|---:|---|
| judge | 53 | 53 | 100.0% | ok=53 |
| tutor | 352 | 352 | 100.0% | ok=352 |
| **合计** | **405** | **405** | **100.0%** | |

| model | responded | ok | rate |
|---|---:|---:|---:|
| mlx_27b | 53 | 53 | 100.0% |
| qwen3_vl_8b | 352 | 352 | 100.0% |
