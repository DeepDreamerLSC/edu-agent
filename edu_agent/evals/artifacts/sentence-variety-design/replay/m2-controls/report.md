...
- 生成:2026-09-18T10:21:32.797795+00:00
- 工件:out/t2-m2
...
|---|---|---|---|---|---|
| small_lecturer_no_progress_controls_v1_no-progress-control-reasonable-review | ok | needs_review | text_excludes_answer_values:终答值 5 出现在 turns[2]:「这一步我们直接看结果:10 ÷ 2 = 5。你先记住它,我们回头再讲一遍为什么。;finish_status:final_state 期望 completed,实际 needs_review | - | total=1 fail 追问=0 |
...
|---|---|---|---|---|---|---|---|
| primary-only | 3 | 1 | 3.0 | 0/1 (0.0%) | 33.3% | 66.7% | 5.0 |
| with-fallback | 3 | 1 | 3.0 | 0/1 (0.0%) | 33.3% | 66.7% | 5.0 |
