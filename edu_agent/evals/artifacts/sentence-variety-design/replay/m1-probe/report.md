...
- 生成:2026-09-18T10:20:12.340383+00:00
- 工件:out/t2-m1
...
|---|---|---|---|---|---|
| m1_probe_corpus_no-progress-real-6a61aa32-replay | ok | needs_review | 全绿 | - | total=3 fail 追问=0 |
| m1_probe_corpus_no-progress-real-paraphrase-probe | ok | needs_review | 全绿 | - | total=5 fail 追问=1 |
...
|---|---|---|---|---|---|---|---|
| primary-only | 2 | 0 | - | 0/0 (-) | 0.0% | 100.0% | 4.0 |
| with-fallback | 2 | 0 | - | 0/0 (-) | 0.0% | 100.0% | 4.0 |
