...
| small_lecturer_teaching_context_shadow_pilot_20_stability_triangle_area | 2 | 3 | 8 | 达标 |
...
M2 门 98%: ✅ 当前 **100.0%** (81/81 产出了结果)

| role | responded | ok | rate | breakdown |
|---|---:|---:|---:|---|
| judge | 11 | 11 | 100.0% | ok=11 |
| tutor | 70 | 70 | 100.0% | ok=70 |
| **合计** | **81** | **81** | **100.0%** | |

| model | responded | ok | rate |
|---|---:|---:|---:|
| mlx_27b | 11 | 11 | 100.0% |
| qwen3_vl_8b | 70 | 70 | 100.0% |
