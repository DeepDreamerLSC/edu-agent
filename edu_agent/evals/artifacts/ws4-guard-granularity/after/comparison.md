...
| small_lecturer_teaching_context_shadow_pilot_20_stability_triangle_area | 3/4 ⚠ |
| small_lecturer_teaching_context_shadow_pilot_20_stability_word_problem | 4/4 |

逐维均分(0-2):首问质量 1.27 | 追问引导 2.00 | 年级适配 2.00 | 节奏 1.82 | 总结与掌握 1.82 | 终止行为 1.82
...
| small_lecturer_dialogue_stability_20_stability_chicken_rabbit | 6 | 9 | 12 | 不劣(噪声主导) |
...
| small_lecturer_teaching_context_shadow_pilot_20_stability_chicken_rabbit | 5 | 5 | 12 | 达标 |
...
逐维均分:见 judge-scores.json;对两轮均值差:+5.14

## json_first_pass(01 §6 结构化输出合规率)

M2 门 98%: ✅ 当前 **100.0%** (72/72 产出了结果)

| role | responded | ok | rate | breakdown |
|---|---:|---:|---:|---|
| judge | 9 | 9 | 100.0% | ok=9 |
| tutor | 63 | 63 | 100.0% | ok=63 |
| **合计** | **72** | **72** | **100.0%** | |

| model | responded | ok | rate |
|---|---:|---:|---:|
| mlx_27b | 9 | 9 | 100.0% |
| qwen3_vl_8b | 63 | 63 | 100.0% |
