...
- **互补件互引**(PM 2026-09-17 裁定两层并存):`small_lecturer_signal_enrichment_v2.json`(signal_enrichment/v2 schema,纯文本题面,信号检测语料,tests/teaching 消费,PR #330 互引)≠ 本件(image_teaching/v1 schema,图片题教学场景,评测线 harness/to_cases 消费面)。
