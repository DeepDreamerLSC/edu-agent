...
逐维均分(0-2):首问质量 1.27 | 追问引导 1.82 | 年级适配 2.00 | 节奏 1.36 | 总结与掌握 1.45 | 终止行为 1.45
...
| small_lecturer_dialogue_stability_20_stability_chicken_rabbit | 6 | 9 | 5 | 低于基线 |
| small_lecturer_dialogue_stability_20_stability_equation_subtract | 7 | 7 | 12 | 达标 |
| small_lecturer_dialogue_stability_20_stability_fraction_addition | 3 | 4 | 9 | 达标 |
| small_lecturer_dialogue_stability_20_stability_triangle_area | 3 | 3 | 8 | 达标 |
| small_lecturer_dialogue_stability_20_stability_word_problem | 11 | 5 | 11 | 不劣(噪声主导) |
| small_lecturer_teaching_context_shadow_pilot_20_stability_chicken_rabbit | 5 | 5 | 5 | 达标 |
| small_lecturer_teaching_context_shadow_pilot_20_stability_equation_subtract | 4 | 4 | 12 | 达标 |
| small_lecturer_teaching_context_shadow_pilot_20_stability_fraction_addition | 3 | 4 | 9 | 达标 |
| small_lecturer_teaching_context_shadow_pilot_20_stability_triangle_area | 2 | 3 | 9 | 达标 |
| small_lecturer_teaching_context_shadow_pilot_20_stability_word_problem | 11 | 8 | 11 | 不劣(噪声主导) |

逐维均分:见 judge-scores.json;对两轮均值差:+3.77

## json_first_pass(01 §6 结构化输出合规率)

M2 门 98%: ✅ 当前 **100.0%** (293/293 产出了结果)

| role | responded | ok | rate | breakdown |
|---|---:|---:|---:|---|
| judge | 55 | 55 | 100.0% | ok=55 |
| tutor | 238 | 238 | 100.0% | ok=238 |
| **合计** | **293** | **293** | **100.0%** | |

| model | responded | ok | rate |
|---|---:|---:|---:|
| mlx_27b | 55 | 55 | 100.0% |
| qwen3_vl_8b | 238 | 238 | 100.0% |
