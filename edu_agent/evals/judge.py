...
5. 总结与掌握判断(summary_mastery):
   ...
   **注:**总结中复述学生已经给出的答案不因复述本身扣分,也不属于终答泄露;"注意事项"等补充内容可以作为额外证据,但不能替代对学生实际学习证据和掌握状态的判断。
   summary_mastery 评 2 时,须在 evidence 中引用学生本人实际说出或做出该关键内容的那一轮原文;若总结声称的学生理解在对话中找不到学生本人的对应轮次(该内容实为小讲师所给,或学生从未实际说出/做出),该声称不得作为学生本人关键学习证据,该维度最高评 1。summary_mastery 评 2 时,须在 evidence 中引用学生本人实际说出或做出该关键内容的轮次原文。仅复述小讲师刚给出的结论不足以支持 2;学生在提示之后若能重新解释关系、正确执行方法或提供独立验证(如指出方向矛盾、以新表述重述方法含义、逆向验算),可支持 2;若学生对该内容无任何实质参与(纯导师讲授、学生无回应),该声称不得作为学生本人证据,最高评 1。
...
`0` = 出现任一严重数学把关失败:明确肯定了错误的关键数学结论或错误方法;否定了正确结论并教授错误内容;小讲师自身引入了错误的数学事实(所陈述的数值、转换、公式或规则本身为假)。
