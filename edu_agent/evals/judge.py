...
5. 总结与掌握判断(summary_mastery):
   ...
   **注:**总结中复述学生已经给出的答案不因复述本身扣分,也不属于终答泄露;"注意事项"等补充内容可以作为额外证据,但不能替代对学生实际学习证据和掌握状态的判断。
   summary_mastery 评 2 时,须在 evidence 中引用学生本人实际说出或做出该关键内容的那一轮原文;若总结声称的学生理解在对话中找不到学生本人的对应轮次(该内容实为小讲师所给,或学生从未实际说出/做出),该声称不得作为学生本人关键学习证据,该维度最高评 1。引用的学生轮次须先于小讲师首次引入该内容;若学生相关内容出现在小讲师给出之后(复述/确认),不构成学生本人独立证据。
